export const LineChartErrorMessages = {
  ...
  // Path Error Messages
  LINE_CHART_PATH_ALL_VALUES_NULL:
    "Path data cannot be generated - all Y values are null or undefined",
  LINE_CHART_PATH_INSUFFICIENT_POINTS:
    "Unable to calculate curved path with insufficient points (minimum 2 required)",
