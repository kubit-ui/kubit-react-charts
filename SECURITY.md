...
We take the security of our project seriously. If you discover any security vulnerabilities, please report them to our security team by emailing [ kubit@opendigitalservices.com](mailto: kubit@opendigitalservices.com). We appreciate your help in responsibly disclosing any issues to us.
...
This project is currently being actively maintained and supported. The following versions are currently supported with security updates:

- Version 0.1.0 | Supported

If you are using an older version, we recommend upgrading to a supported version to ensure you have the latest security patches.
