...
/**
 * Creates adaptive focus ring layers from a DOM SVGElement (for targetRef mode).
 *
 ...
 *
 * Unlike createFocusRingLayers which works with React elements,
 * this works with actual DOM SVGElements.
 *
 ...
 */
export function createFocusRingLayersFromDOM(
  element: SVGElement,
